...
# 主要网络的训练代码是：python train.py --modeltype mdm_bert --cos_loss 10 --text_cos_loss 2 --evaluator_train /home/deli/project/text-to-motion/checkpoints/t2m/0716_evaluator32_infosim_fixmovement_cos5/model/finest.tar --add_clip_lora。
## 几个关键参数的解释
