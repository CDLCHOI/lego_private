...
class SALAD(nn.Module):
    def __init__(self):
        ...
        self.conv_enc = STConvEncoder(vae_opt)
        self.conv_dec = STConvDecoder(vae_opt, self.conv_enc)

        # input & output process
        self.input_process = InputProcess(opt, vae_opt.latent_dim)
        self.output_process = OutputProcess(opt, vae_opt.latent_dim)
