...
class FrozenCLIPTextEncoder(nn.Module):
    ...
    def __init__(self, opt):
        ...
        if opt.clip_version == "ViT-B/32":
            # path = '/home/deli/.cache/clip/'
            # path = 'openai/clip-vit-base-patch32'
            # self.tokenizer = AutoTokenizer.from_pretrained(path, local_files_only=True,)
            # self.model = AutoModel.from_pretrained(path)
            self.tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path='/home/deli/project/salad/checkpoints/clip-vit-base-patch32')
            self.model = AutoModel.from_pretrained(pretrained_model_name_or_path='/home/deli/project/salad/checkpoints/clip-vit-base-patch32')
