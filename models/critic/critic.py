...
class MotionCritic(nn.Module):
    def __init__(self, device='cpu', dim_in=3, dim_out=3, dim_feat=256, dim_rep=512,
        ...
        super().__init__()
        self.device = device
        self.mlp = MLP(in_features=num_joints*dim_rep, hidden_features=2*dim_rep, out_features=1)
...
if __name__ == '__main__':
    net = MotionCritic(depth=1, dim_feat=256, dim_rep=512, mlp_ratio=4, num_joints=22+1)
    input = torch.rand(8,196,23,3)
