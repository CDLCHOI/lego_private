...
class CMDM(torch.nn.Module):
    def __init__(self, modeltype, njoints=67, nfeats=1, num_actions=0, translation=True, pose_rep='rot6d', glob=True, glob_rot=True, 
        ...
        assert self.dataset in ['t2m', 'kit'], self.dataset
        ...
        n_joints = 22 if self.dataset == 't2m' else 21
    ...
    def encode_text(self, raw_text):
        ...
        if max_text_len is not None:
            ...
            raise ValueError('max_text_len is None')
    ...
    def mdm_forward(self, x, timesteps, y=None, control=None):
        ...
        if 'text' in self.cond_mode:
            if 'text_emb' in y.keys():
                enc_text = y['text_emb'] # to speedup test process
            else:
