import torch
from models.snapmogen_evaluator.modules import Encoder, EncoderV2, MLP, length_to_mask
...
class EvaluatorWrapper:
    def __init__(
        ...
        try:
            ...
            self.text_enc.load_state_dict(model_weights['text_encoder'])

        try:
            self.latent_enc.load_state_dict(model_weights['motion_encoder'])
        except:
